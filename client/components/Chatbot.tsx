...
export default function Chatbot() {
  ...
  return (
    <div id="chatbot" className="fixed bottom-6 right-6 z-50">
      <div
        className={cn(
          "w-[88vw] sm:w-[380px] card p-0 overflow-hidden transition-all",
          open
        ...
        <div className="h-[320px] overflow-y-auto px-4 py-3 space-y-3 bg-gradient-to-b from-background to-secondary/30">
          {messages.length === 0 && (
            <div className="text-sm text-muted-foreground">
              Ask about products, shipping times, or recommendations. I can help
              you find the right items for the US market.
            </div>
          )}
          {messages.map((m) => (
            <div
